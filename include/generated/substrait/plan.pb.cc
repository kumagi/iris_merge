...
PROTOBUF_CONSTEXPR Plan::Plan(
  ...
  , /*decltype(_impl_.parameter_bindings_)*/{}
...
PROTOBUF_CONSTEXPR DynamicParameterBinding::DynamicParameterBinding(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.value_)*/nullptr
  , /*decltype(_impl_.parameter_anchor_)*/0u
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct DynamicParameterBindingDefaultTypeInternal {
  PROTOBUF_CONSTEXPR DynamicParameterBindingDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 DynamicParameterBindingDefaultTypeInternal _DynamicParameterBinding_default_instance_;
}  // namespace substrait
static ::_pb::Metadata file_level_metadata_substrait_2fplan_2eproto[5];
...
const uint32_t TableStruct_substrait_2fplan_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::substrait::Plan, _impl_.parameter_bindings_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::substrait::DynamicParameterBinding, _impl_.parameter_anchor_),
  PROTOBUF_FIELD_OFFSET(::substrait::DynamicParameterBinding, _impl_.value_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::substrait::PlanRel)},
  { 9, -1, -1, sizeof(::substrait::Plan)},
  { 22, -1, -1, sizeof(::substrait::PlanVersion)},
  { 29, -1, -1, sizeof(::substrait::Version)},
  { 40, -1, -1, sizeof(::substrait::DynamicParameterBinding)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::substrait::_DynamicParameterBinding_default_instance_._instance,
};
...
const char descriptor_table_protodef_substrait_2fplan_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "bindings\030\007 \003(\0132\".substrait.DynamicParame"
  "terBinding\"2\n\013PlanVersion\022#\n\007version\030\006 \001"
  "(\0132\022.substrait.Version\"o\n\007Version\022\024\n\014maj"
  "or_number\030\001 \001(\r\022\024\n\014minor_number\030\002 \001(\r\022\024\n"
  "\014patch_number\030\003 \001(\r\022\020\n\010git_hash\030\004 \001(\t\022\020\n"
  "\010producer\030\005 \001(\t\"a\n\027DynamicParameterBindi"
  "ng\022\030\n\020parameter_anchor\030\001 \001(\r\022,\n\005value\030\002 "
  "\001(\0132\035.substrait.Expression.LiteralBf\n\022io"
  ".substrait.protoP\001Z9github.com/substrait"
  "-io/substrait-protobuf/go/substraitpb\252\002\022"
  "Substrait.Protobufb\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_substrait_2fplan_2eproto = {
    false, false, 946, descriptor_table_protodef_substrait_2fplan_2eproto,
    "substrait/plan.proto",
    &descriptor_table_substrait_2fplan_2eproto_once, descriptor_table_substrait_2fplan_2eproto_deps, 2, 5,
...
Plan::Plan(const Plan& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.parameter_bindings_){from._impl_.parameter_bindings_}
    , decltype(_impl_.advanced_extensions_){nullptr}
    , decltype(_impl_.version_){nullptr}
    , /*decltype(_impl_._cached_size_)*/{}};
...
inline void Plan::SharedCtor(
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.parameter_bindings_){arena}
    , decltype(_impl_.advanced_extensions_){nullptr}
    , decltype(_impl_.version_){nullptr}
    , /*decltype(_impl_._cached_size_)*/{}
  };
...
inline void Plan::SharedDtor() {
  ...
  _impl_.parameter_bindings_.~RepeatedPtrField();
...
uint8_t* Plan::_InternalSerialize(
  ...
  // repeated .substrait.DynamicParameterBinding parameter_bindings = 7;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_parameter_bindings_size()); i < n; i++) {
    const auto& repfield = this->_internal_parameter_bindings(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
...
// @@protoc_insertion_point(message_byte_size_start:substrait.Plan)
  ...
  for (const auto& msg : this->_impl_.parameter_bindings_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
void Plan::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.parameter_bindings_.MergeFrom(from._impl_.parameter_bindings_);
  if (from._internal_has_advanced_extensions()) {
...
DynamicParameterBinding::DynamicParameterBinding(const DynamicParameterBinding& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  DynamicParameterBinding* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.value_){nullptr}
    , decltype(_impl_.parameter_anchor_){}
    , /*decltype(_impl_._cached_size_)*/{}};
...
const char* DynamicParameterBinding::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          _impl_.parameter_anchor_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else {
          goto handle_unusual;
}
...
uint8_t* DynamicParameterBinding::_InternalSerialize(
  ...
  if (this->_internal_parameter_anchor() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(1, this->_internal_parameter_anchor(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:substrait.DynamicParameterBinding)
  ...
  // uint32 parameter_anchor = 1;
  if (this->_internal_parameter_anchor() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_parameter_anchor());
  }
...
void DynamicParameterBinding::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_parameter_anchor() != 0) {
    _this->_internal_set_parameter_anchor(from._internal_parameter_anchor());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
template<> PROTOBUF_NOINLINE ::substrait::DynamicParameterBinding*
Arena::CreateMaybeMessage< ::substrait::DynamicParameterBinding >(Arena* arena) {
